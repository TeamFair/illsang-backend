...
import com.illsang.quest.domain.model.quset.MissionDetailModel
...
data class MissionDetailResponse(
    ...
    val labels: List<MissionLabelResponse>,
    ...
    companion object {
        fun from(missionModel: MissionDetailModel): MissionDetailResponse {
            return MissionDetailResponse(
                ...
                labels = missionModel.labels.map { MissionLabelResponse.from(it) },
