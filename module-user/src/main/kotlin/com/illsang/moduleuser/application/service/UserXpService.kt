...
class UserXpService(
     ...
     */
    fun getUserXpByUserIdAndXpType(userId: Long, xpType: com.illsang.moduleuser.domain.model.XpType): UserXpModel? {
     ...
     */
    @Transactional
    fun addPoint(userId: Long, xpType: com.illsang.moduleuser.domain.model.XpType, additionalPoint: Int): UserXpModel? {
